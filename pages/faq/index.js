...
const Home = () => {
    return (
      ...
      <div className="flex min-h-screen flex-col items-center justify-center ">
        <CustomHeader 
          titleText="Frequently Asked Questions • Athinia"
          descriptionText="Frequently Asked Questions About Athinia™"
          url="https://athinia.com/about/faq/"
        />        
