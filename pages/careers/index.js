    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center lg:justify-center">
                <CustomHeader
                    titleText="Careers • Athinia"
                    descriptionText="Are you ready to lead the semiconductor industry revolution? We are looking for champions who are ready to unlock the power of data to build the future of semiconductors."
                    url="https://athinia.com/about/careers/"
                />
