    ...
    return (
        <>
            ...
            <div className="flex min-h-screen">
                <CustomHeader
                    titleText="Contact & News • Athinia"
                    descriptionText="Interested in exploring the possibilities Athinia™ can unlock for your organization? We would love to hear from you."
                    url="https://athinia.com/contact/"
                />                
