  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col items-center mb-[1.75rem] md:mb-[4.5rem] lg:mb-[9rem]">
        <CustomHeader 
          titleText="Offering for Device Makers • Athinia"
          descriptionText="With Athinia™’s ability to safeguard data, you can feel confident in sharing information with material suppliers and creating a virtually and vertically integrated manufacturing flow. This unprecedented sharing of data can accelerate yield and overall performance."
          url="https://athinia.com/data-collaboration/device-makers/"
        />        
