...
const GetInContact = ({
  ...
  const yPosAnimBlueTwo = useTransform(
    ...
    [1, 0.5],
    width > 1024 ? [300, 0] : (isException ? (width > 768 ? [0, -80] : [0, -100]) : (width > 768 ? [0, -75] : [0, -100]))
  );

  const xPosAnimBlueTwo = useTransform(
    scrollYProgressBlueTwo,
    [1, 0.5],
    width > 1024 ? [100, 0] : (isException ? (width > 768 ? [100, -60] : [100, -100]) : (width > 768 ? [100, -60] : [100, -90]))
  );
  ...
  const yPosAnimBluePurple = useTransform(
    ...
    width > 1024 ? [-150, 0] : (isException ? (width > 768 ? [-200, 20] : [-200, 100]) : (width > 768 ? [-200, 20] : [-200, 80]))
  );

  const xPosAnimBluePurple = useTransform(
    scrollYProgressPurple,
    [1, 0.5],
    width > 1024 ? [-200, 0] : (isException ? (width > 768 ? [-200, -40] : [-200, 0]) : (width > 768 ? [-200, -40] : [-200, -8]))
  );
